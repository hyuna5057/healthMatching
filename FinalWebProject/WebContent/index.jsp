                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">이젠 고객님께서 '직접'</h1>
                               
                                    <h1 class="animation animated-item-1">선택할 수 있습니다.</h1>
                                    <h2 class="animation animated-item-2">유명한 트레이너와 함께</h2>
                                     <h2 class="animation animated-item-2">몸을 만들어 보세요.</h2>
                                    <!-- <a class="btn-slide animation animated-item-3" href="#">참가 신청</a> -->
                                </div>
                            </div>

                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                                <div class="slider-img">
                                    <img src="images/slider/shon1.png" class="img-responsive">
                                </div>
                            </div>
    ...
    <section id="recent-works">
        <div class="container">
            ...
            <div class="center wow fadeInDown">
                <h2>현재 활동중인 트레이너</h2>
                <p class="lead">현재 9882명의 트레이너가 활동 중입니다.</p>
            </div>
